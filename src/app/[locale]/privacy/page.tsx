...
const SECTIONS = [
  { key: 'collect', items: 3, hasLead: true },
  { key: 'use', items: 4, hasLead: true },
  { key: 'sharing', items: 1, hasLead: false },
  { key: 'security', items: 1, hasLead: false },
  { key: 'rights', items: 3, hasLead: true },
  { key: 'cookies', items: 1, hasLead: false },
  { key: 'changes', items: 1, hasLead: false },
] as const;
          ...
          <div className="grid gap-10 lg:grid-cols-12 lg:gap-12">
            ...
            <div className="lg:col-span-9">
              <div className="space-y-7 sm:space-y-9">
                {SECTIONS.map(({ key, items, hasLead }, sectionIdx) => (
                  <article
                    key={key}
                    id={`section-${key}`}
                  ...
                  >
                    ...
                    {/* 可选引导句 — 子条目列表前的导语 */}
                    {hasLead && (
                      <p className="mt-3 text-[15px] leading-[1.65] text-gray-700 sm:text-base">
                        {t(`sections.${key}.lead`)}
                      </p>
                    )}
